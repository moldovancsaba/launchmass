...
3. ~~Add co-author line: `Co-Authored-By: Warp <agent@warp.dev>`~~ — superseded by
   the AI-attribution ban (`CLAUDE.md`/`AGENTS.md` §1); left struck through rather
   than deleted so this remains an accurate historical record of what this document
