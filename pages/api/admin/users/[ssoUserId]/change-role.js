...
import { syncPermissionToSSO } from '../../../../../lib/ssoPermissions.js';
...
async function handler(req, res) {
  ...
  try {
    ...
    logAdminAction('change_role', null, req.user?.ssoUserId, { targetSsoUserId: ssoUserId, role });
...
export default withSsoAuth(requireAdminRole(handler, 'Only admins can change roles'));
