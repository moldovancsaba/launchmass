...
/**
 * Functional: Shared, process-wide MongoClient connection promise.
 * Strategic: Every other lib/ module (users.js, org.js, permissions.js) awaits this
 * single promise rather than opening its own connection; see the module-level
 * comment above for why a global cache is required on serverless.
 *
 * @type {Promise<MongoClient>}
 */
